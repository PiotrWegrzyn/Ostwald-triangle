...
class SetMeasuredScreen(Screen):
    def __init__(self, **kw):
        ...
        self.back_button = TransitionButton(text="Back", transition_method="right", size_hint=(0.1, 1))
        ...
        self.input_grid.add_widget(ColoredLabel(text="CO2", bg_color=(.3, .3, 1, .85), size_hint_x=0.5))
        self.input_grid.add_widget(self.co2_input)

        self.o2_input = TextInput(text="2", size_hint_x=0.5)
        self.input_grid.add_widget(ColoredLabel(text="O2", bg_color=(.3, .3, 1, .85), size_hint_x=0.5))
